...
public class SurchargeRepositoryImpl implements Repository<Surcharge, Long>, iuh.fit.se.group1.repository.interfaces.SurchargeRepository {

    private static final Logger log = LoggerFactory.getLogger(SurchargeRepositoryImpl.class);
